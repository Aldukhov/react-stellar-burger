...
import {
	...
	resetPas,
} from '../../../services/actions/resetPas'
...
const NewPassword: React.FC = () => {
	...
	const { resetSuccess: resetAuth } = useSelector(state => state.forgetForm)
	...
	const { resetRequest, resetSuccess } = useSelector(state => state.resetForm)
