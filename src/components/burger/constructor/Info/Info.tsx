...
import {
	IConstructorItemType,
	IOrderType,
} from '../../../../services/types/apiDataTypes'
...
const Info: React.FC = () => {
	...
	const price: number = items.reduce(
		(accum: number, currentItem: IConstructorItemType): number => {
	...
	return (
		<div className={classNames(styles.info, 'mt-10 mb-13')}>
			<div className={classNames(styles.info__price, 'mr-10')}>
				<p className={classNames('text text_type_digits-medium', 'pr-2')}>
					{price}
				</p>
